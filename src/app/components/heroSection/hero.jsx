    ...
    return(
        <div className=" bg-[#394649] text-white flex flex-col items-center ">
            ...
            <HiOutlineMail className=" relative left-8 text-[#7F8C89]"/>
                <input type="number" placeholder="Мобилен телефон" className=" h-20 rounded-xl w-80 text-center place-self-center text-black" max="10" />
                <p className=" h-20 border-2 rounded-xl w-30 bg-[#E7F874] text-[#083C2F] text-center p-6 relative right-4 border-transparent rounded-tl-none rounded-bl-none">Изпрати</p>
